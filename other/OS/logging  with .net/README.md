...
|-------|--------|--------|----------------|
| 0 | [Phase-00-Foundations](other/OS/logging%20%20with%20.net/Phase-00-Foundations/README.md) | What logging is, levels, structured logs | 1–2 days |
| 1 | [Phase-01-DotNet-Logging](other/OS/logging%20%20with%20.net/Phase-01-DotNet-Logging/README.md) | `ILogger`, Serilog, ASP.NET Core | 3–5 days |
| 2 | [Phase-02-Elasticsearch-Basics](other/OS/logging%20%20with%20.net/Phase-02-Elasticsearch-Basics/README.md) | Elasticsearch & Kibana concepts | 3–5 days |
| 3 | [Phase-03-DotNet-To-Elasticsearch](other/OS/logging%20%20with%20.net/Phase-03-DotNet-To-Elasticsearch/README.md) | Wire .NET 9 to Elasticsearch | 5–7 days |
| 4 | [Phase-04-Production-Patterns](other/OS/logging%20%20with%20.net/Phase-04-Production-Patterns/README.md) | ILM, security, reliability | 1–2 weeks |
| 5 | [Phase-05-Beyond-Plain-Logs](other/OS/logging%20%20with%20.net/Phase-05-Beyond-Plain-Logs/README.md) | OpenTelemetry, APM (optional) | 1–2 weeks |
...
**Start here:** [Phase 00 — Foundations](other/OS/logging%20%20with%20.net/Phase-00-Foundations/README.md)
